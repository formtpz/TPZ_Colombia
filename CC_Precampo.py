...
def CC_Precampo(usuario,puesto):
  ...
  tipo_de_errores_3= placeholder14_3.multiselect("Tipo de Errores", options=("Errores topológicos","Digitalización de construcciones","Derecho interesado fuente","Georreferenciación","Errores en aplicativo","Creación de F","Validadores","Consultas a campo","Consultas a jurídico","Predios en omision","N/A"), key="tipo_de_errores_3")
  ...
  # ----- Bonos y Horas Extras ---- #
    ...
    cursor01.execute(f"INSERT INTO cc_paquetes (usuario, nombre, supervisor, proceso, tipo, paquete, horas, produccion, produccion_aprobados, produccion_rechazados, estado, porcentage_error, usuario_calidad, nombre_calidad, ratio_limpio_predio_por_dia, primera_reinspeccion, segunda_reinspeccion, porcentage_penalizacion_ratio, ratio_penalizado_predio_por_dia, fecha_produccion, fecha_corte, fecha_bono, horas_bi)VALUES('{usuario_objeto_cc}','{operador_3}','{supervisor_objeto_cc}','Control de Calidad Precampo', '{tipo_3}', '0','{horas_3}', '{produccion_3}', '{aprobados_3}', '{rechazados_3}', 'N/A', '0','{usuario}','{nombre_3}','0','0','0','0','0','0','0','0','{horas_bi}' )")
    con.commit()
