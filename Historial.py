...
def Historial(usuario,puesto):
  ...
  if puesto=="Supervisor" or puesto=="Coordinador":    
    ...
    tipo_7_s = placeholder12_7.selectbox("Tipo", options=("Todos","Ordinario","Corrección","Inspección","Reinspección","Primera Reinspección","Segunda Reinspección","No Aplica"), key="tipo_7_s")
  ...
  # ----- Operario Catastral y Profesional Jurídico ---- #
    ...
    tipo_7_o = placeholder34_7.selectbox("Tipo", options=("Todos","Ordinario","Corrección","Inspección","Reinspección","Primera Reinspección","Segunda Reinspección","No Aplica"), key="tipo_7_s")
