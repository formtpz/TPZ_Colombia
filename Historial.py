...
def Historial(usuario,puesto):
  ...
  if puesto=="Supervisor" or puesto=="Técnico SIG" or puesto=="Coordinador":    
    ...
    if personal_7=="Todos" and proceso_7_s=="Todos" and tipo_7_s=="Todos":
      ...
      data_1_r=pd.read_sql(f"select COALESCE(cast(id as integer), 0),marca,usuario,nombre,puesto,supervisor,proceso,fecha,semana,año,unidad_asignacion,uit,hito,lote,estado,zona,area,COALESCE(cast(efes as float), 0.0),COALESCE(cast(informales as float), 0.0),paquete,con_fmi,sin_fmi,tipo,COALESCE(cast(produccion as float), 0.0),COALESCE(cast(aprobados as float), 0.0),COALESCE(cast(rechazados as float), 0.0),operador_cc,total_de_errores,errores_por_excepciones,tipo_calidad,tipo_de_errores,conteo_de_errores,COALESCE(cast(horas as float), 0.0)from registro where fecha>='{fecha_de__inicio_7}' and fecha<='{fecha_de__finalizacion_7}'", con)
      ...
      data_1_r=pd.read_sql(f"select COALESCE(cast(id as integer), 0),marca,usuario,nombre,puesto,supervisor,proceso,fecha,semana,año,unidad_asignacion,uit,hito,lote,estado,zona,area,COALESCE(cast(efes as float), 0.0),COALESCE(cast(informales as float), 0.0),paquete,con_fmi,sin_fmi,tipo,COALESCE(cast(produccion as float), 0.0),COALESCE(cast(aprobados as float), 0.0),COALESCE(cast(rechazados as float), 0.0),operador_cc,total_de_errores,errores_por_excepciones,tipo_calidad,tipo_de_errores,conteo_de_errores,COALESCE(cast(horas as float), 0.0)from registro where tipo='{tipo_7_s}' and fecha>='{fecha_de__inicio_7}' and fecha<='{fecha_de__finalizacion_7}'", con)
      ...
      data_1_r=pd.read_sql(f"select COALESCE(cast(id as integer), 0),marca,usuario,nombre,puesto,supervisor,proceso,fecha,semana,año,unidad_asignacion,uit,hito,lote,estado,zona,area,COALESCE(cast(efes as float), 0.0),COALESCE(cast(informales as float), 0.0),paquete,con_fmi,sin_fmi,tipo,COALESCE(cast(produccion as float), 0.0),COALESCE(cast(aprobados as float), 0.0),COALESCE(cast(rechazados as float), 0.0),operador_cc,total_de_errores,errores_por_excepciones,tipo_calidad,tipo_de_errores,conteo_de_errores,COALESCE(cast(horas as float), 0.0)from registro where proceso='{proceso_7_s}' and fecha>='{fecha_de__inicio_7}' and fecha<='{fecha_de__finalizacion_7}'", con)
      ...
      data_1_r=pd.read_sql(f"select COALESCE(cast(id as integer), 0),marca,usuario,nombre,puesto,supervisor,proceso,fecha,semana,año,unidad_asignacion,uit,hito,lote,estado,zona,area,COALESCE(cast(efes as float), 0.0),COALESCE(cast(informales as float), 0.0),paquete,con_fmi,sin_fmi,tipo,COALESCE(cast(produccion as float), 0.0),COALESCE(cast(aprobados as float), 0.0),COALESCE(cast(rechazados as float), 0.0),operador_cc,total_de_errores,errores_por_excepciones,tipo_calidad,tipo_de_errores,conteo_de_errores,COALESCE(cast(horas as float), 0.0)from registro where proceso='{proceso_7_s}' and tipo='{tipo_7_s}'  and fecha>='{fecha_de__inicio_7}' and fecha<='{fecha_de__finalizacion_7}'", con)
      ...
      data_1_r=pd.read_sql(f"select COALESCE(cast(id as integer), 0),marca,usuario,nombre,puesto,supervisor,proceso,fecha,semana,año,unidad_asignacion,uit,hito,lote,estado,zona,area,COALESCE(cast(efes as float), 0.0),COALESCE(cast(informales as float), 0.0),paquete,con_fmi,sin_fmi,tipo,COALESCE(cast(produccion as float), 0.0),COALESCE(cast(aprobados as float), 0.0),COALESCE(cast(rechazados as float), 0.0),operador_cc,total_de_errores,errores_por_excepciones,tipo_calidad,tipo_de_errores,conteo_de_errores,COALESCE(cast(horas as float), 0.0)from registro where puesto='Operario Catastral' and fecha>='{fecha_de__inicio_7}' and fecha<='{fecha_de__finalizacion_7}'", con)
      ...
      data_1_r=pd.read_sql(f"select COALESCE(cast(id as integer), 0),marca,usuario,nombre,puesto,supervisor,proceso,fecha,semana,año,unidad_asignacion,uit,hito,lote,estado,zona,area,COALESCE(cast(efes as float), 0.0),COALESCE(cast(informales as float), 0.0),paquete,con_fmi,sin_fmi,tipo,COALESCE(cast(produccion as float), 0.0),COALESCE(cast(aprobados as float), 0.0),COALESCE(cast(rechazados as float), 0.0),operador_cc,total_de_errores,errores_por_excepciones,tipo_calidad,tipo_de_errores,conteo_de_errores,COALESCE(cast(horas as float), 0.0)from registro where puesto='Operario Catastral' and tipo='{tipo_7_s}' and fecha>='{fecha_de__inicio_7}' and fecha<='{fecha_de__finalizacion_7}'", con)
      ...
      data_1_r=pd.read_sql(f"select COALESCE(cast(id as integer), 0),marca,usuario,nombre,puesto,supervisor,proceso,fecha,semana,año,unidad_asignacion,uit,hito,lote,estado,zona,area,COALESCE(cast(efes as float), 0.0),COALESCE(cast(informales as float), 0.0),paquete,con_fmi,sin_fmi,tipo,COALESCE(cast(produccion as float), 0.0),COALESCE(cast(aprobados as float), 0.0),COALESCE(cast(rechazados as float), 0.0),operador_cc,total_de_errores,errores_por_excepciones,tipo_calidad,tipo_de_errores,conteo_de_errores,COALESCE(cast(horas as float), 0.0)from registro where puesto='Operario Catastral' and proceso = '{proceso_7_s}' and fecha>='{fecha_de__inicio_7}' and fecha<='{fecha_de__finalizacion_7}'", con)
      ...
      data_1_r=pd.read_sql(f"select COALESCE(cast(id as integer), 0),marca,usuario,nombre,puesto,supervisor,proceso,fecha,semana,año,unidad_asignacion,uit,hito,lote,estado,zona,area,COALESCE(cast(efes as float), 0.0),COALESCE(cast(informales as float), 0.0),paquete,con_fmi,sin_fmi,tipo,COALESCE(cast(produccion as float), 0.0),COALESCE(cast(aprobados as float), 0.0),COALESCE(cast(rechazados as float), 0.0),operador_cc,total_de_errores,errores_por_excepciones,tipo_calidad,tipo_de_errores,conteo_de_errores,COALESCE(cast(horas as float), 0.0)from registro where puesto='Operario Catastral' and proceso = '{proceso_7_s}' and tipo='{tipo_7_s}' and fecha>='{fecha_de__inicio_7}' and fecha<='{fecha_de__finalizacion_7}'", con)
      ...
      data_1_r=pd.read_sql(f"select COALESCE(cast(id as integer), 0),marca,usuario,nombre,puesto,supervisor,proceso,fecha,semana,año,unidad_asignacion,uit,hito,lote,estado,zona,area,COALESCE(cast(efes as float), 0.0),COALESCE(cast(informales as float), 0.0),paquete,con_fmi,sin_fmi,tipo,COALESCE(cast(produccion as float), 0.0),COALESCE(cast(aprobados as float), 0.0),COALESCE(cast(rechazados as float), 0.0),operador_cc,total_de_errores,errores_por_excepciones,tipo_calidad,tipo_de_errores,conteo_de_errores,COALESCE(cast(horas as float), 0.0)from registro where puesto='Profesional Jurídico' and fecha>='{fecha_de__inicio_7}' and fecha<='{fecha_de__finalizacion_7}'", con)
      ...
      data_1_r=pd.read_sql(f"select COALESCE(cast(id as integer), 0),marca,usuario,nombre,puesto,supervisor,proceso,fecha,semana,año,unidad_asignacion,uit,hito,lote,estado,zona,area,COALESCE(cast(efes as float), 0.0),COALESCE(cast(informales as float), 0.0),paquete,con_fmi,sin_fmi,tipo,COALESCE(cast(produccion as float), 0.0),COALESCE(cast(aprobados as float), 0.0),COALESCE(cast(rechazados as float), 0.0),operador_cc,total_de_errores,errores_por_excepciones,tipo_calidad,tipo_de_errores,conteo_de_errores,COALESCE(cast(horas as float), 0.0)from registro where puesto='Profesional Jurídico' and tipo='{tipo_7_s}' and fecha>='{fecha_de__inicio_7}' and fecha<='{fecha_de__finalizacion_7}'", con)
      ...
      data_1_r=pd.read_sql(f"select COALESCE(cast(id as integer), 0),marca,usuario,nombre,puesto,supervisor,proceso,fecha,semana,año,unidad_asignacion,uit,hito,lote,estado,zona,area,COALESCE(cast(efes as float), 0.0),COALESCE(cast(informales as float), 0.0),paquete,con_fmi,sin_fmi,tipo,COALESCE(cast(produccion as float), 0.0),COALESCE(cast(aprobados as float), 0.0),COALESCE(cast(rechazados as float), 0.0),operador_cc,total_de_errores,errores_por_excepciones,tipo_calidad,tipo_de_errores,conteo_de_errores,COALESCE(cast(horas as float), 0.0)from registro where puesto='Profesional Jurídico' and proceso = '{proceso_7_s}' and fecha>='{fecha_de__inicio_7}' and fecha<='{fecha_de__finalizacion_7}'", con)
      ...
      data_1_r=pd.read_sql(f"select COALESCE(cast(id as integer), 0),marca,usuario,nombre,puesto,supervisor,proceso,fecha,semana,año,unidad_asignacion,uit,hito,lote,estado,zona,area,COALESCE(cast(efes as float), 0.0),COALESCE(cast(informales as float), 0.0),paquete,con_fmi,sin_fmi,tipo,COALESCE(cast(produccion as float), 0.0),COALESCE(cast(aprobados as float), 0.0),COALESCE(cast(rechazados as float), 0.0),operador_cc,total_de_errores,errores_por_excepciones,tipo_calidad,tipo_de_errores,conteo_de_errores,COALESCE(cast(horas as float), 0.0)from registro where puesto='Profesional Jurídico' and proceso = '{proceso_7_s}' and tipo='{tipo_7_s}' and fecha>='{fecha_de__inicio_7}' and fecha<='{fecha_de__finalizacion_7}'", con)
      ...
      data_1_r=pd.read_sql(f"select COALESCE(cast(id as integer), 0),marca,usuario,nombre,puesto,supervisor,proceso,fecha,semana,año,unidad_asignacion,uit,hito,lote,estado,zona,area,COALESCE(cast(efes as float), 0.0),COALESCE(cast(informales as float), 0.0),paquete,con_fmi,sin_fmi,tipo,COALESCE(cast(produccion as float), 0.0),COALESCE(cast(aprobados as float), 0.0),COALESCE(cast(rechazados as float), 0.0),operador_cc,total_de_errores,errores_por_excepciones,tipo_calidad,tipo_de_errores,conteo_de_errores,COALESCE(cast(horas as float), 0.0)from registro where usuario='{usuario}' and fecha>='{fecha_de__inicio_7}' and fecha<='{fecha_de__finalizacion_7}'", con)
      ...
      data_1_r=pd.read_sql(f"select COALESCE(cast(id as integer), 0),marca,usuario,nombre,puesto,supervisor,proceso,fecha,semana,año,unidad_asignacion,uit,hito,lote,estado,zona,area,COALESCE(cast(efes as float), 0.0),COALESCE(cast(informales as float), 0.0),paquete,con_fmi,sin_fmi,tipo,COALESCE(cast(produccion as float), 0.0),COALESCE(cast(aprobados as float), 0.0),COALESCE(cast(rechazados as float), 0.0),operador_cc,total_de_errores,errores_por_excepciones,tipo_calidad,tipo_de_errores,conteo_de_errores,COALESCE(cast(horas as float), 0.0)from registro where usuario='{usuario}' and tipo='{tipo_7_s}' and fecha>='{fecha_de__inicio_7}' and fecha<='{fecha_de__finalizacion_7}'", con)
      ...
      data_1_r=pd.read_sql(f"select COALESCE(cast(id as integer), 0),marca,usuario,nombre,puesto,supervisor,proceso,fecha,semana,año,unidad_asignacion,uit,hito,lote,estado,zona,area,COALESCE(cast(efes as float), 0.0),COALESCE(cast(informales as float), 0.0),paquete,con_fmi,sin_fmi,tipo,COALESCE(cast(produccion as float), 0.0),COALESCE(cast(aprobados as float), 0.0),COALESCE(cast(rechazados as float), 0.0),operador_cc,total_de_errores,errores_por_excepciones,tipo_calidad,tipo_de_errores,conteo_de_errores,COALESCE(cast(horas as float), 0.0)from registro where usuario='{usuario}' and proceso = '{proceso_7_s}' and fecha>='{fecha_de__inicio_7}' and fecha<='{fecha_de__finalizacion_7}'", con)
      ...
      data_1_r=pd.read_sql(f"select COALESCE(cast(id as integer), 0),marca,usuario,nombre,puesto,supervisor,proceso,fecha,semana,año,unidad_asignacion,uit,hito,lote,estado,zona,area,COALESCE(cast(efes as float), 0.0),COALESCE(cast(informales as float), 0.0),paquete,con_fmi,sin_fmi,tipo,COALESCE(cast(produccion as float), 0.0),COALESCE(cast(aprobados as float), 0.0),COALESCE(cast(rechazados as float), 0.0),operador_cc,total_de_errores,errores_por_excepciones,tipo_calidad,tipo_de_errores,conteo_de_errores,COALESCE(cast(horas as float), 0.0)from registro where usuario='{usuario}' and proceso = '{proceso_7_s}' and tipo='{tipo_7_s}' and fecha>='{fecha_de__inicio_7}' and fecha<='{fecha_de__finalizacion_7}'", con)
      ...
      data_1_r=pd.read_sql(f"select COALESCE(cast(id as integer), 0),marca,usuario,nombre,puesto,supervisor,proceso,fecha,semana,año,unidad_asignacion,uit,hito,lote,estado,zona,area,COALESCE(cast(efes as float), 0.0),COALESCE(cast(informales as float), 0.0),paquete,con_fmi,sin_fmi,tipo,COALESCE(cast(produccion as float), 0.0),COALESCE(cast(aprobados as float), 0.0),COALESCE(cast(rechazados as float), 0.0),operador_cc,total_de_errores,errores_por_excepciones,tipo_calidad,tipo_de_errores,conteo_de_errores,COALESCE(cast(horas as float), 0.0)from registro where supervisor='{nombre_7}' and fecha>='{fecha_de__inicio_7}' and fecha<='{fecha_de__finalizacion_7}'", con)
      ...
      data_1_r=pd.read_sql(f"select COALESCE(cast(id as integer), 0),marca,usuario,nombre,puesto,supervisor,proceso,fecha,semana,año,unidad_asignacion,uit,hito,lote,estado,zona,area,COALESCE(cast(efes as float), 0.0),COALESCE(cast(informales as float), 0.0),paquete,con_fmi,sin_fmi,tipo,COALESCE(cast(produccion as float), 0.0),COALESCE(cast(aprobados as float), 0.0),COALESCE(cast(rechazados as float), 0.0),operador_cc,total_de_errores,errores_por_excepciones,tipo_calidad,tipo_de_errores,conteo_de_errores,COALESCE(cast(horas as float), 0.0)from registro where supervisor='{nombre_7}' and tipo='{tipo_7_s}' and fecha>='{fecha_de__inicio_7}' and fecha<='{fecha_de__finalizacion_7}'", con)
      ...
      data_1_r=pd.read_sql(f"select COALESCE(cast(id as integer), 0),marca,usuario,nombre,puesto,supervisor,proceso,fecha,semana,año,unidad_asignacion,uit,hito,lote,estado,zona,area,COALESCE(cast(efes as float), 0.0),COALESCE(cast(informales as float), 0.0),paquete,con_fmi,sin_fmi,tipo,COALESCE(cast(produccion as float), 0.0),COALESCE(cast(aprobados as float), 0.0),COALESCE(cast(rechazados as float), 0.0),operador_cc,total_de_errores,errores_por_excepciones,tipo_calidad,tipo_de_errores,conteo_de_errores,COALESCE(cast(horas as float), 0.0)from registro where supervisor='{nombre_7}' and proceso='{proceso_7_s}' and fecha>='{fecha_de__inicio_7}' and fecha<='{fecha_de__finalizacion_7}'", con)
      ...
      data_1_r = pd.read_sql(f"select COALESCE(cast(id as integer), 0),marca,usuario,nombre,puesto,supervisor,proceso,fecha,semana,año,unidad_asignacion,uit,hito,lote,estado,zona,area,COALESCE(cast(efes as float), 0.0),COALESCE(cast(informales as float), 0.0),paquete,con_fmi,sin_fmi,tipo,COALESCE(cast(produccion as float), 0.0),COALESCE(cast(aprobados as float), 0.0),COALESCE(cast(rechazados as float), 0.0),operador_cc,total_de_errores,errores_por_excepciones,tipo_calidad,tipo_de_errores,conteo_de_errores,COALESCE(cast(horas as float), 0.0)from registro where supervisor='{nombre_7}' and proceso='{proceso_7_s}' and  proceso='{tipo_7_s}' and fecha>='{fecha_de__inicio_7}' and fecha<='{fecha_de__finalizacion_7}'", con)
  ...
  # ----- Operario Catastral y Profesional Jurídico ---- #
    ...
    if proceso_7_o =="Todos" and tipo_7_o=="Todos":
      ...
      data_5_r=pd.read_sql(f"select COALESCE(cast(id as integer), 0),marca,usuario,nombre,puesto,supervisor,proceso,fecha,semana,año,unidad_asignacion,uit,hito,lote,estado,zona,area,COALESCE(cast(efes as float), 0.0),COALESCE(cast(informales as float), 0.0),paquete,con_fmi,sin_fmi,tipo,COALESCE(cast(produccion as float), 0.0),COALESCE(cast(aprobados as float), 0.0),COALESCE(cast(rechazados as float), 0.0),operador_cc,total_de_errores,errores_por_excepciones,tipo_calidad,tipo_de_errores,conteo_de_errores,COALESCE(cast(horas as float), 0.0) from registro where operador_cc='{nombre_7}' and fecha>='{fecha_de__inicio_7}' and fecha<='{fecha_de__finalizacion_7}'", con)
      data_1_c = pd.read_sql(f"select cast(id as integer),marca,usuario,nombre,puesto,supervisor,fecha,tema,cast(horas as float),observaciones,reporte from capacitaciones where usuario='{usuario}' and fecha>='{fecha_de__inicio_7}' and fecha<='{fecha_de__finalizacion_7}'", con)
      ...
      data_1_r=pd.read_sql(f"select COALESCE(cast(id as integer), 0),marca,usuario,nombre,puesto,supervisor,proceso,fecha,semana,año,unidad_asignacion,uit,hito,lote,estado,zona,area,COALESCE(cast(efes as float), 0.0),COALESCE(cast(informales as float), 0.0),paquete,con_fmi,sin_fmi,tipo,COALESCE(cast(produccion as float), 0.0),COALESCE(cast(aprobados as float), 0.0),COALESCE(cast(rechazados as float), 0.0),operador_cc,total_de_errores,errores_por_excepciones,tipo_calidad,tipo_de_errores,conteo_de_errores,COALESCE(cast(horas as float), 0.0)from registro where usuario='{usuario}' and tipo='{tipo_7_o}' and fecha>='{fecha_de__inicio_7}' and fecha<='{fecha_de__finalizacion_7}'", con)
      #-----importar la base completa sin filtro de usuario para jalar operador cc en la vista resumen
      data_5_r=pd.read_sql(f"select COALESCE(cast(id as integer), 0),marca,usuario,nombre,puesto,supervisor,proceso,fecha,semana,año,unidad_asignacion,uit,hito,lote,estado,zona,area,COALESCE(cast(efes as float), 0.0),COALESCE(cast(informales as float), 0.0),paquete,con_fmi,sin_fmi,tipo,COALESCE(cast(produccion as float), 0.0),COALESCE(cast(aprobados as float), 0.0),COALESCE(cast(rechazados as float), 0.0),operador_cc,total_de_errores,errores_por_excepciones,tipo_calidad,tipo_de_errores,conteo_de_errores,COALESCE(cast(horas as float), 0.0) from registro where operador_cc='{nombre_7}' and fecha>='{fecha_de__inicio_7}' and fecha<='{fecha_de__finalizacion_7}'", con)
      data_1_c = pd.read_sql(f"select cast(id as integer),marca,usuario,nombre,puesto,supervisor,fecha,tema,cast(horas as float),observaciones,reporte from capacitaciones where usuario='{usuario}' and fecha>='{fecha_de__inicio_7}' and fecha<='{fecha_de__finalizacion_7}'", con)
      ...
      data_1_r=pd.read_sql(f"select COALESCE(cast(id as integer), 0),marca,usuario,nombre,puesto,supervisor,proceso,fecha,semana,año,unidad_asignacion,uit,hito,lote,estado,zona,area,COALESCE(cast(efes as float), 0.0),COALESCE(cast(informales as float), 0.0),paquete,con_fmi,sin_fmi,tipo,COALESCE(cast(produccion as float), 0.0),COALESCE(cast(aprobados as float), 0.0),COALESCE(cast(rechazados as float), 0.0),operador_cc,total_de_errores,errores_por_excepciones,tipo_calidad,tipo_de_errores,conteo_de_errores,COALESCE(cast(horas as float), 0.0)from registro where usuario='{usuario}' and proceso='{proceso_7_o}' and fecha>='{fecha_de__inicio_7}' and fecha<='{fecha_de__finalizacion_7}'", con)
      #-----importar la base completa sin filtro de usuario para jalar operador cc en la vista resumen
      data_5_r=pd.read_sql(f"select COALESCE(cast(id as integer), 0),marca,usuario,nombre,puesto,supervisor,proceso,fecha,semana,año,unidad_asignacion,uit,hito,lote,estado,zona,area,COALESCE(cast(efes as float), 0.0),COALESCE(cast(informales as float), 0.0),paquete,con_fmi,sin_fmi,tipo,COALESCE(cast(produccion as float), 0.0),COALESCE(cast(aprobados as float), 0.0),COALESCE(cast(rechazados as float), 0.0),operador_cc,total_de_errores,errores_por_excepciones,tipo_calidad,tipo_de_errores,conteo_de_errores,COALESCE(cast(horas as float), 0.0) from registro where operador_cc='{nombre_7}' and fecha>='{fecha_de__inicio_7}' and fecha<='{fecha_de__finalizacion_7}'", con)
      data_1_c = pd.read_sql(f"select cast(id as integer),marca,usuario,nombre,puesto,supervisor,fecha,tema,cast(horas as float),observaciones,reporte from capacitaciones where usuario='{usuario}' and fecha>='{fecha_de__inicio_7}' and fecha<='{fecha_de__finalizacion_7}'", con)
      ...
      data_1_r=pd.read_sql(f"select COALESCE(cast(id as integer), 0),marca,usuario,nombre,puesto,supervisor,proceso,fecha,semana,año,unidad_asignacion,uit,hito,lote,estado,zona,area,COALESCE(cast(efes as float), 0.0),COALESCE(cast(informales as float), 0.0),paquete,con_fmi,sin_fmi,tipo,COALESCE(cast(produccion as float), 0.0),COALESCE(cast(aprobados as float), 0.0),COALESCE(cast(rechazados as float), 0.0),operador_cc,total_de_errores,errores_por_excepciones,tipo_calidad,tipo_de_errores,conteo_de_errores,COALESCE(cast(horas as float), 0.0)from registro where usuario='{usuario}' and proceso='{proceso_7_o}' and tipo='{tipo_7_o}' and fecha>='{fecha_de__inicio_7}' and fecha<='{fecha_de__finalizacion_7}'", con)
      #-----importar la base completa sin filtro de usuario para jalar operador cc en la vista resumen
      data_5_r=pd.read_sql(f"select COALESCE(cast(id as integer), 0),marca,usuario,nombre,puesto,supervisor,proceso,fecha,semana,año,unidad_asignacion,uit,hito,lote,estado,zona,area,COALESCE(cast(efes as float), 0.0),COALESCE(cast(informales as float), 0.0),paquete,con_fmi,sin_fmi,tipo,COALESCE(cast(produccion as float), 0.0),COALESCE(cast(aprobados as float), 0.0),COALESCE(cast(rechazados as float), 0.0),operador_cc,total_de_errores,errores_por_excepciones,tipo_calidad,tipo_de_errores,conteo_de_errores,COALESCE(cast(horas as float), 0.0) from registro where operador_cc='{nombre_7}' and fecha>='{fecha_de__inicio_7}' and fecha<='{fecha_de__finalizacion_7}'", con)
      data_1_c = pd.read_sql(f"select cast(id as integer),marca,usuario,nombre,puesto,supervisor,fecha,tema,cast(horas as float),observaciones,reporte from capacitaciones where usuario='{usuario}' and fecha>='{fecha_de__inicio_7}' and fecha<='{fecha_de__finalizacion_7}'", con)
