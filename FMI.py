...
def FMI(usuario,puesto):
  ...
  # ----- Bonos ---- #
    ...
    cursor01.execute(f"INSERT INTO registro (marca,usuario,nombre,puesto,supervisor,proceso,fecha,unidad_asignacion,tipo,produccion,aprobados,rechazados,horas)VALUES('{marca_3}','{usuario}','{nombre_3}','{puesto}','{supervisor_3}','Folios de Matricula Inmobiliaria','{fecha_3}','{unidad_3}','NA','{produccion_3}','0','0','0')")
    con.commit()                                                                                                                                 
