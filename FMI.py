...
def FMI(usuario,puesto):
  ...
  estado_3= placeholder13_3.selectbox("Estado", options=("Revisión de Folios","Control de Calidad Precampo","Predios sin Geometría","Devuelto a Campo", "Control de Calidad Post Campo", "Control de Calidad Previo XTF (Externo)"), key="estado_3")
