...
def Estado_UIT_Hito(usuario,puesto):
  ...
  # ----- Bonos y Horas Extra---- #
    ...
    cursor01.execute(f"INSERT INTO registro (marca,usuario,nombre,puesto,supervisor,proceso,fecha,semana,año,unidad_asignacion,tipo,produccion,aprobados,rechazados,horas,uit,hito,lote,estado,area,efes,informales,paquete,con_fmi,sin_fmi)VALUES('{marca_3}','{usuario}','{nombre_3}','{puesto}','{supervisor_3}','Estado UIT Hito','{fecha_3}','{semana_3}','{año_3}','{municipio_3}','0','0','0','0','0','{uit_3}','{hito_3}','{lote_3}','{estado_3}','0','0','0','0','0','0','0')")
    con.commit()                                                                                                                                 
