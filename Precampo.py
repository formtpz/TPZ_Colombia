...
def Precampo(usuario,puesto):
  ...
  tipo_3= placeholder14_3.selectbox("Tipo", options=("Ordinario","Reproceso Ordinario","Corrección de Calidad","En conflicto"), key="tipo_3")
  
  placeholder15_3= st.empty()
  estado_3= placeholder15_3.selectbox("Estado" , options=("Finalizado"),key="estado_3")
