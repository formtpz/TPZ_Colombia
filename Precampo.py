...
def Precampo(usuario,puesto):
  ...
  paquete_3= placeholder14_3.text_input("Nombre del Paquete" ,max_chars=40,key="paquete_3")
  ...
  produccion_3= placeholder19_3.number_input("Cantidad Total de Predios Producidos",min_value=0,step=1,key="produccion_3")
  ...
  # ----- Bonos y Horas Extras ---- #
    ...
    cursor01.execute(f"INSERT INTO registro (marca,usuario,nombre,puesto,supervisor,proceso,fecha,semana,año,unidad_asignacion,tipo,produccion,aprobados,rechazados,horas,uit,hito,lote,estado,area,efes,informales,paquete)VALUES('{marca_3}','{usuario}','{nombre_3}','{puesto}','{supervisor_3}','Precampo','{fecha_3}','{semana_3}','{año_3}','{unidad_3}','{tipo_3}','{produccion_3}','0','0','{horas_3}','{uit_3}','{hito_3}','{lote_3}','{estado_3}','{area_3}','{efes_3}','{informales_3}','{paquete_3}')")
    con.commit()                                                                                                                                 
