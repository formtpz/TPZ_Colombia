...
def Precampo(usuario,puesto):
  ...
  tipo_3= placeholder14_3.selectbox("Tipo", options=("Ordinario","Reproceso Ordinario","Corrección de Calidad","Corrección de Calidad Otro Operador","En conflicto","Control de Calidad Externa"), key="tipo_3")
