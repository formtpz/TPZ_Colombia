...
def Precampo(usuario,puesto):
  ...
  produccion_3= placeholder13_3.number_input("Cantidad de Predios Producidos (si contienen F, reportar la mitad, ej: 10 ordinarios + 10 f = 15 predios)",min_value=0.0,step=0.5,key="produccion_3")
