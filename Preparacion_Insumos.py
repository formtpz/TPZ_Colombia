...
def Preparacion_Insumos(usuario,puesto):
  ...
  # ----- Bonos y Horas Extras ---- #
    ...
    if municipio_3 in lote_3_municipios:
      ...
      lote_3 = '1'
      # ----- Fin del script ---- #
    cursor01.execute(f"INSERT INTO registro (marca,usuario,nombre,puesto,supervisor,proceso,fecha,semana,año,unidad_asignacion,tipo,produccion,aprobados,rechazados,horas,uit,hito,lote,estado,area,efes,informales,paquete,con_fmi,sin_fmi,observaciones,zona,tipo_calidad,horas_bi,area_bi,operador_cc)VALUES('{marca_3}','{usuario}','{nombre_3}','{puesto}','{supervisor_3}','Preparación de Insumos','{fecha_3}','{semana_3}','{año_3}','{municipio_3}','Ordinario','{produccion_3}','0','0','{horas_3}','UIT-0','0','{lote_3}','N/A','0.0','0','0','P0','0','0','N/A','N/A','N/A','{horas_bi}','0','N/A')")
    con.commit()                                                                                                                                 
