...
def Validacion(usuario,puesto):
  ...
  tipo_3= placeholder15_3.selectbox("Tipo", options=("Ordinario","Reproceso Ordinario","Corrección de Calidad","Corrección de Calidad Otro Operador","En conflicto","Control de Calidad Externa"), key="tipo_3")
