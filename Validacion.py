...
def Validacion(usuario,puesto):
  ...
  tipo_3= placeholder15_3.selectbox("Tipo", options=("Ordinario","Reproceso Ordinario","Corrección de Calidad Ordinaria","Corrección de Calidad Extraordinaria","Corrección de Calidad Otro Operador","En conflicto","Control de Calidad Externa","Capacitación"), key="tipo_3")
