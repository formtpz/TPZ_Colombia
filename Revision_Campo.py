...
def Revision_Campo(usuario,puesto):
  ...
  consecutivo_3= placeholder11_3.text_input("Número de Paquete",max_chars=10,key="consecutivo_3")
  ...
  # ----- Bonos y Horas Extras ---- #
    ...
    cursor01.execute(f"INSERT INTO registro (marca,usuario,nombre,puesto,supervisor,proceso,fecha,semana,año,unidad_asignacion,tipo,produccion,aprobados,rechazados,horas,uit,hito,lote,estado,area,efes,informales,paquete,con_fmi,sin_fmi,observaciones,zona,tipo_calidad,horas_bi,area_bi,operador_cc)VALUES('{marca_3}','{usuario}','{nombre_3}','{puesto}','{supervisor_3}','Revisión de Campo','{fecha_3}','{semana_3}','{año_3}','{unidad_3}','{tipo_3}','{produccion_3}','{aprobados_3}','{rechazados_3}','{horas_3}','UIT-0','0','{lote_3}','N/A','0.0','0','0','P0','0','0','N/A','{zona_3}','N/A','{horas_bi}','0','N/A')")
    con.commit()                                                                                                                                 
