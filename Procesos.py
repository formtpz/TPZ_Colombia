...
import Historial, Capacitacion, Otros_Registros, Bonos_Extras, Salir, FMI, Consulta_Campo,Restitucion_Tierras,Revision_Segregados,Calidad_Externa_XTF,Precampo, CC_Precampo, Preparacion_Insumos, Revision_Campo, Validacion, CC_Validacion
...
def Procesos1(usuario,puesto):
    ...
    if st.session_state.Procesos==False: 
        ...
        calidad_externa_xtf = placeholder18_2.button("Calidad Externa XTF",key="calidad_externa_xtf")
        ...
        elif st.session_state.Calidad_Externa_XTF==True:
            Estado_UIT_Hito.Estado_UIT_Hito(usuario,puesto)
