...
import Correcciones, Historial, Capacitacion, Otros_Registros, Bonos_Extras, Salir, FMI, Consulta_Campo,Restitucion_Tierras,Revision_Segregados, Estado_UIT_Hito, Precampo, CC_Precampo, Preparacion_Insumos, Revision_Campo, Validacion, CC_Validacion
...
def Procesos1(usuario,puesto):
    ...
    if st.session_state.Procesos==False: 
        ...
        estado_uit_hito = placeholder11_2.button("Revisión de Planos",key="estado_uit_hito")
        ...
        cc_precampo_2 = placeholder18_2.button("Control de Calidad Precampo",key="cc_precampo_2")
...
def Procesos2(usuario,puesto):
    ...
    if st.session_state.Procesos==False:
        ...
        estado_uit_hito = placeholder9_2_1.button("Revisión de Planos",key="estado_uit_hito")
