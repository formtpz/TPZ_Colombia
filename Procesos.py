...
import Historial, Capacitacion, Otros_Registros, Bonos_Extras, Salir, FMI, CC_FMI, Consulta_Campo, Precampo, CC_Precampo, Validacion, PR_Validacion
# ----- Procesos 1 ---- #
...
def Procesos2(usuario,puesto):
    ...
    if st.session_state.Procesos==False:
        ...
        placeholder10_2 = st.empty()
        cc_validacion_2 = placeholder10_2.button("Control de Calidad Validación",key="cc_validacion_2")
