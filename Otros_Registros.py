...
def Otros_Registros(usuario,puesto):
  ...
  if puesto== "Coordinador":
    ...
    motivo_13= placeholder11_13.selectbox("Motivo", options=("Cita CCSS","Entregas","Incapacidad","Control de Calidad Informalidades Especiales", "Informalidades Especiales","Fallos en Aplicativo o Conexión","Horas Extras","Licencia por Fallecimiento de Familiar","Licencia por Maternidad, Paternidad o Lactancia","Paneo de Omisiones y Comisiones", "Reunión", "Supervisión","Ubicación","Vacaciones", "Otros"),key="motivo_13")
    ...
    placeholder11_13= st.empty()
    motivo_13= placeholder11_13.selectbox("Motivo", options=("Cita CCSS","Entregas","Incapacidad","Control de Calidad Informalidades Especiales", "Informalidades Especiales","Fallos en Aplicativo o Conexión","Licencia por Fallecimiento de Familiar","Licencia por Maternidad, Paternidad o Lactancia", "Reunión","Paneo de Omisiones y Comisiones", "Supervisión","Ubicación","Vacaciones", "Otros"),key="motivo_13")
