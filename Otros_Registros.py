...
def Otros_Registros(usuario,puesto):
  ...
  if puesto== "Coordinador":
    ...
    motivo_13= placeholder11_13.selectbox("Motivo", options=("Entregas","Incapacidad","Control de Calidad Informalidades Especiales", "Informalidades Especiales","Fallos en Aplicativo o Conexión","Licencia por Fallecimiento de Familiar","Licencia por Maternidad, Paternidad o Lactancia", "Reunión", "Supervisión","Ubicación","Vacaciones", "Otros"),key="motivo_13")
